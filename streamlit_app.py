...
st.sidebar.markdown('This is an example of using a custom Toolhouse LlamaIndex tool created by Toolhouse and <a href="https://ai.jdavis.xyz" target="_blank">0xjdavis</a>.', unsafe_allow_html=True)
